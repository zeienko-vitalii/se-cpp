 ...
 */
class Window: public MStorageInterface {
	/**
...
public:
	 ...
	 * @param _windowId - window id which must be set
	 * @param _x1 - x1 coordinate which must be set
	 * @param _y1 - y1 coordinate which must be set
	 * @param _x2 - x2 coordinate which must be set
	 * @param _y2 - y2 coordinate which must be set
	 */
	 ...
	 * @return |x1-x2| - width of the screen
	 */
	int width() const;

	/**
	 * Returns height of the screen.
	 * @return |y1-y2| - height of the screen
	 */
	int height() const;
